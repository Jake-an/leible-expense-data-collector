...
class StepExecutor:
    ...
    def _build_step_review_prompt(
        self, step_num: int, step_file_rel: str, sha_before: str, result_rel: str
    ) -> str:
        return (
    ...
    def _run_step_reviewer(self, step: dict, sha_before: str, model: str) -> dict | None:
        step_num = step["step"]
        ...
        prompt = self._build_step_review_prompt(step_num, step_file_rel, sha_before, result_rel)
    ...
    def _step_review_gate(self, step: dict, sha_before: str):
        ...
        self._finalize_step_review(step_num, step_name, result, fix_rounds)
