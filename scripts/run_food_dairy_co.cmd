...
set "LOG=logs\food_dairy_co.log"
echo ===== [%DATE% %TIME%] run_food_dairy_co start ===== >> "%LOG%"
python -u connectors\playwright\food_dairy_co.py >> "%LOG%" 2>&1
set EXIT_CODE=%ERRORLEVEL%
echo ===== [%DATE% %TIME%] run_food_dairy_co exit=%EXIT_CODE% ===== >> "%LOG%"
